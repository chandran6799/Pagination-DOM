...
description.innerText =
  "Pagination is the process of dividing a large data set into multiple pages.";
...
async function paginationData() {
  ...
  try {
    ...
    let addEvent_1st = document.getElementById("event-btn-1");
    addEvent_1st.addEventListener("click", () => {
      starting_value = 0;
      display_contents(starting_value);
    });
